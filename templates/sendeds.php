					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h3 class="panel-title">
								<i class="fa fa-send fa-fw"></i> Liste des SMS envoyés
								<div class="pull-right">
									<a class="btn btn-default btn-xs" href="<?php echo $this->generateUrl('sendeds', ($page != 0 ? 'showAll' : ''), ($page != 0 ? array('page' => $page) : array())); ?>"><i class="fa fa-refresh fa-fw"></i> Actualiser</a>
								</div>
							</h3>
						</div>
